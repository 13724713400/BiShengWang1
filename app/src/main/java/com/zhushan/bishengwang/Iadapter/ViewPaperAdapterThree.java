 ...
 */
public class ViewPaperAdapterThree extends PagerAdapter {
    private List<GalleryDataTwo> imageViewList;
    private Context context;
    public ViewPaperAdapterThree(Context context, List<GalleryDataTwo> imageViewList)
    {
