 ...
 */
public class HompageItemAdapter extends CommonBaseAdapter<HomePageInfoData>   {
    private double lat,lng;
    private PositionMySeft positionMySeft;
    public HompageItemAdapter(final Activity context, List datas, int resourceId) {
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
       ...
       RelativeLayout homepage_item_xinxi =  commonViewHolder.getView(R.id.homepage_item_xinxi);
        ...
        homepage_item_gunazhuimg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (token!=null) {
                    ...
                    map.put("token",token);
                    map.put("fromid",datas.get(position).getId());
                    HttpFactory.getInstance().focusInfo(context, map);
                }else{
        ...
        if (datas.get(position).getHead_thumb().contains("Uploads")) {
            ...
            commonViewHolder.setCircleImageUrlByGlide(context, datas.get(position).getHead_thumb(), homepage_item_touxiang);
        }
        ...
        if (datas.get(position).getImg()!=null) {
            ...
            if (datas.get(position).getImg().size()==1) {
                ...
                commonViewHolder .setImageUrlByGlide(context, HttpConstance.URL + datas.get(position).getImg().get(0).getImg_thumb(), homepage_item_img1);
                homepage_item_img2.setVisibility(View.INVISIBLE);
                homepage_item_img3.setVisibility(View.INVISIBLE);
                homepage_item_img1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                      //  EventBus.getDefault().post(datas.get(position).getImg());
                        Bundle bundle = new Bundle();
                        bundle.putParcelableArrayList("HompageItemAdapter",datas.get(position).getImg());
                        bundle.putInt("index", 0);
                        IntentUtils.getInstance().startToAnoterActivity(context, Activity_Imgdetails.class, bundle);
            ...
            if (datas.get(position).getImg().size()==2) {
                ...
                homepage_item_img2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
            ...
            if (datas.get(position).getImg().size()==3) {
                ...
                homepage_item_img2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        bundle.putInt("index", 1);
                        bundle.putParcelableArrayList("HompageItemAdapter",datas.get(position).getImg());
                        Log.i("www","tupian"+datas.get(position).getImg());
                        IntentUtils.getInstance().startToAnoterActivity(context, Activity_Imgdetails.class, bundle);
                        ((Activity)context).overridePendingTransition(R.anim.zoomin, R.anim.zoomout);
                    }
                });

                homepage_item_img3.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
        ...
        if (datas.get(position).getNickname()!=null&&datas.get(position).getTitle()!=null&& datas.get(position).getContent()!=null&&datas.get(position).getArea()!=null&&datas.get(position).getFoucsCount()!=null&&datas.get(position).getHit()!=null&& datas.get(position).getMessageCount()!=null&&datas.get(position).getLat()!=null&&datas.get(position).getLng()!=null&&datas.get(position).getAddtime()!=null) {
            ...
            commonViewHolder.setText(R.id.homepage_item_Name, datas.get(position).getNickname())
                    ...
                    .setText(R.id.homepage_item_guanzhu, context.getResources().getString(R.string.guanzhu2) + "  " + datas.get(position).getFoucsCount())
     ...
     /*   homepage_item_xinxi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Bundle bundle = new Bundle();
