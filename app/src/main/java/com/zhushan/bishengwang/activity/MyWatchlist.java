...
public class MyWatchlist extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (adapter.getCount()==0){
            ...
            listview.setBackgroundResource(R.color.main_me_text);
    ...
    class MyAdapter1 extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            inflater = MyWatchlist.this.getLayoutInflater();
            ...
            if (convertView == null) {
                ...
                //根据自定义的Item布局加载布局
                convertView = mInflater.inflate(R.layout.i_notice_list, null);
            ...
            Button btn = (Button) convertView.findViewById(R.id.yi_guanzhu);
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mDialog=null;
                    listview.setAdapter(adapter);
                    mDialog = new AlertDialog.Builder(MyWatchlist.this).setView(view).show();
                    listview.setAdapter(adapter);
                }
