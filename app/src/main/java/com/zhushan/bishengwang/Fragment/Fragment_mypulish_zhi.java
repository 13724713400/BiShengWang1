 ...
 */
public class Fragment_mypulish_zhi extends Fragment {
    ...
    private void initData() {
        ...
        if (bundle!=null)
        {
            ...
            HttpFactory.getInstance().HisPublicZhi(getActivity(),map,pullToRefreshListView);
            ...
            map.put("page", String.valueOf(0));
            map.put("cate_id", String.valueOf(4));
            HttpFactory.getInstance().MyPublicZhi(getActivity(), map, pullToRefreshListView);
        }
    ...
    public void onEventMainThread(MyPublicZhiEntry myPublicEntry)
    {
