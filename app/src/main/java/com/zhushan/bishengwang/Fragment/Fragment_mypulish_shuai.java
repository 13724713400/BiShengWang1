 ...
 */
public class Fragment_mypulish_shuai extends Fragment {
    ...
    private void initData() {
        ...
        if (bundle!=null)
        {
            ...
            HttpFactory.getInstance().HisPublicShuai(getActivity(),map,pullToRefreshListView);
            ...
            map.put("page", String.valueOf(0));
            map.put("cate_id", String.valueOf(2));
            HttpFactory.getInstance().MyPublic(getActivity(), map, pullToRefreshListView);
        }
 ...
 public void onEventMainThread(ShuaiEntry s)
    {
        Log.i("www", "s" + s);
        isGet = true;

            myPublicDatas2.clear();
            Log.i("www", "myPublicDatas2" + myPublicDatas2+"");
            map.put("token", SharePreferenceUtils.getInstance(getActivity(), SharePreferenceConstance.USERNAME).getSharePreferenceString(SharePreferenceConstance.USERTOKEN, null));
            map.put("page", String.valueOf(0));
            map.put("cate_id", String.valueOf(2));
            HttpFactory.getInstance().MyPublic(getActivity(), map, pullToRefreshListView);
    ...
    public void onEventMainThread(MyPublicEntry myPublicEntry)
    {
        Log.i("www","chuadi"+myPublicEntry);
