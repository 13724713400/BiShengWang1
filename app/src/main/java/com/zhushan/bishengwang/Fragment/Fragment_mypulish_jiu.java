 ...
 */
public class Fragment_mypulish_jiu extends Fragment {
    ...
    private void initData() {
       ...
       final Bundle bundle = getActivity().getIntent().getExtras();
        if (bundle!=null)
        {
            ...
            HttpFactory.getInstance().HisPublicJiu(getActivity(),map,pullToRefreshListView);
            ...
            map.put("page", String.valueOf(0));
            map.put("cate_id", String.valueOf(3));
            HttpFactory.getInstance().MyPublicJiu(getActivity(), map, pullToRefreshListView);
        }
    ...
    public void onEventMainThread(ZhiEntry s)
    {
    ...
    public void onEventMainThread(MyPublicJiuEntry myPublicEntry)
    {
